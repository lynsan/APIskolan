<?php $page = 'oppna-data';require('components/header.inc.php')?>
    ...
    <div class="main-content" onclick="hide_menu()">
        <section>
            ...
            <br>
            <p>När du går och hämtar öppna data på myndighetens webbplats så får du all data, så du får själv rota igenom all data efter just den informationen du är ute efter. Om du behöver ha färska siffror och uppdaterad data, ja då får du gå tillbaka till webbplatsen med jämna mellanrum och hämta det senaste versionen av datan.</p>
            <br>
            <p>Om du nu istället använder dig av ett API så kan du be om endast de specifika data du är ute efter, och du får alltid den senaste datan.</p>
            <div class="callout">
